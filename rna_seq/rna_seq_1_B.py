...
def seq_list_from_fastq_file(fastq_filename):
    seq_list=[]
    line_count=0
    with open (fastq_filename,'r') as object_file:
	...
	# 1. open a new file obj from our fastq_filename

	# 2. use a for loop to read line

    # 3. is our line a sequence line?

    # 4. add sequence to seq_list

    ## end your code
    # 5. return seq_list to use in other code
